...
namespace ConsoleApp1
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            var printUCAM = UCAM.Calculate(root, printable_2);
            Console.WriteLine("UCAM ratio:" + printUCAM);
            var printUCAC = UCAC.Calculate(root, printable_3);
            Console.WriteLine("UACA ratio:" + printUCAC);
            var printCDP = CDP.Calculate(root, printable_3.Count());
            ...
            var printCMI = CMI.Calculate(root, printable_2, printable_3);
            Console.WriteLine("CMI ratio:" + printCMI);
            var printCAI = CAI.Calculate(root, printable, printable_3);
            Console.WriteLine("CAI ratio:" + printCAI);
            //-------------------------------------------------------
            //table 2 
            var printRCA = RandW_Security_Metrics.RCA(printable_70, printable_80, printCAI);//CAI eklenecek
            var printWCA = RandW_Security_Metrics.WCA(printable_12, printable_11, printable_17);
            var printRCM = RandW_Security_Metrics.RCM(printable_90, printCMI);
            var printWCM = RandW_Security_Metrics.WCM(printable_15, printable_13, printable_16, printUCAM);
            var printRCC = RandW_Security_Metrics.RCC(printRPB, printCDP, printCSP);
