...
namespace ConsoleApp1
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            var printable_8 = CCC.Calculate(root, printable, printable_3);
            ...
            /*var printable_4 = CCDA.Calculate(root);
            Console.WriteLine("Number of Non-Private Class Attributes:" + printable_4.Count());
            var printable_5 = CIDA.Calculate(root, printable_4); // Calismasi icin CCDA'dan gelen list gerekli.
            Console.WriteLine("Number of Non-Private Instance Attributes:" + printable_5.Count());
            var printable_6 = COA.Calculate(root, printable);
            Console.WriteLine("Number of Non-Private Methods:" + printable_6.Count());
            ...
            bool printable_10 = RPB.Calculate(tree);
            Console.WriteLine(printable_10);
