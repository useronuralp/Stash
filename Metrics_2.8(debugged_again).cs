...
namespace ConsoleApp1
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            /*foreach (var hello in printable_3)
            {
                Console.WriteLine("Critical classes: "+hello);
            }*/
            /*
