...
namespace ConsoleApp1
{
    ...
    public class OOP_Metrics
    {
        ...
        public static int Check_Constractor(Microsoft.CodeAnalysis.SyntaxNode root)
        {
    ...
    class Program
    {
        static void Main()
        {
            ...
            int check_Constructor = OOP_Metrics.Check_Constractor(root);//true veya false dönüyor bunu 1 0 yap 
