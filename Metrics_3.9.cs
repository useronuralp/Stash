...
namespace ConsoleApp1
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            Console.WriteLine("Security Design Principle Metric Score: " + System.Math.Round((Total_security_Index / 123) * 100, 1)); // 123 alabileceği max değer o yüzden bu değerle %liğe çviriyoruz
            //others--------------------------------------------------------------------------
            Console.WriteLine("----------------------------------------------------------------");
            ...
            Console.WriteLine("OOP Metrics grade: " + Total_Grade_of_OOP_Metrics);
            ...
            Console.WriteLine("Technique usage grade: " + Total_grade_of_tech_usage);
            //others--------------------------------------------------------------------------
            ...
            Console.WriteLine("Testabilty grade: " + System.Math.Round((total / 3) * 100), 2);
